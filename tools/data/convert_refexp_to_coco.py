...
def convert_to_coco(data_root='/mnt/data/refcoco', output_root='/mnt/data/refcoco_referformer', dataset='refcoco', dataset_split='unc'):
    ...
    print('There are %s expressions for %s refereed objects in %s images.' % (
